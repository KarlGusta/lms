  ...
  <body >
    ...
    <!-- This is the start of the aside Navigation bar -->
      ...
      <div class="page-wrapper">
        <div class="page-body">
        <div class="container-xl">
         <!-- THIS IS WHERE ALL THE CONTENTS SHOULD BE-->
        </div>
        </div>   
    ...
    <!-- This is the modal for the "Create new report" button -->
    ...
    <!-- This is the end of the modal for "Create New Report" button -->
